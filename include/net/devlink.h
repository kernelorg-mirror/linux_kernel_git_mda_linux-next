...
enum devlink_param_generic_id {
	...
	DEVLINK_PARAM_GENERIC_ID_CTF_QUEUES,
...
#define DEVLINK_PARAM_GENERIC_CTF_QUEUES_NAME "ctf_queues"
#define DEVLINK_PARAM_GENERIC_CTF_QUEUES_TYPE DEVLINK_PARAM_TYPE_U32
